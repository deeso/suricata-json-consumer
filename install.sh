...
sudo mkdir /opt/suricata-consumer
...
sudo chmod a+x /opt/suricata-consumer/suricata-json-consumer.py
sudo chmod a+x /opt/suricata-consumer/suricata-json-consumer.sh

# copy start-up files and add the Ubuntu service
sudo cp svc-suricata-json-consumer.sh /etc/init.d/
sudo chmod a+x /etc/init.d/svc-suricata-json-consumer.sh
